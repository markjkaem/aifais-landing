    ...
    <main className="bg-black min-h-screen">
      ...
      */}
      <section className="relative pt-24 pb-12 px-6 overflow-hidden text-center">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-purple-900/20 blur-[100px] rounded-full pointer-events-none" />

        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="inline-block mb-6 px-4 py-2 bg-purple-950/30 border border-purple-500/30 rounded-full">
