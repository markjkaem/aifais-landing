...
// ============================================
// SECTOR CONFIGURATION (30 sectors)
// ============================================
...
export const SECTORS: Sector[] = [
  ...
  { id: "logistics", name: "Logistiek & Supply Chain", icon: Truck, color: "slate", gradient: "from-slate-500 to-gray-600", accentColor: "#64748b" },
  { id: "healthcare", name: "Zorg & Welzijn", icon: Heart, color: "red", gradient: "from-red-500 to-pink-600", accentColor: "#ef4444" },
  { id: "education", name: "Onderwijs & Training", icon: GraduationCap, color: "indigo", gradient: "from-indigo-500 to-blue-600", accentColor: "#6366f1" },
  { id: "realestate", name: "Vastgoed", icon: Home, color: "amber", gradient: "from-amber-500 to-yellow-600", accentColor: "#f59e0b" },
  { id: "hospitality", name: "Horeca", icon: Utensils, color: "orange", gradient: "from-orange-500 to-red-600", accentColor: "#f97316" },
  { id: "automotive", name: "Automotive", icon: Car, color: "zinc", gradient: "from-zinc-500 to-slate-600", accentColor: "#71717a" },
  { id: "travel", name: "Reizen & Toerisme", icon: Plane, color: "sky", gradient: "from-sky-500 to-blue-600", accentColor: "#0ea5e9" },
  { id: "consulting", name: "Consulting", icon: Briefcase, color: "slate", gradient: "from-slate-600 to-gray-700", accentColor: "#475569" },
  { id: "sustainability", name: "Duurzaamheid", icon: Leaf, color: "green", gradient: "from-green-500 to-emerald-600", accentColor: "#22c55e" },
  ...
  { id: "media", name: "Media & Publishing", icon: Camera, color: "rose", gradient: "from-rose-500 to-red-600", accentColor: "#f43f5e" },
  { id: "entertainment", name: "Entertainment", icon: Gamepad2, color: "purple", gradient: "from-purple-500 to-violet-600", accentColor: "#a855f7" },
  { id: "manufacturing", name: "Productie & Industrie", icon: Factory, color: "stone", gradient: "from-stone-500 to-zinc-600", accentColor: "#78716c" },
  { id: "construction", name: "Bouw", icon: Wrench, color: "yellow", gradient: "from-yellow-500 to-orange-600", accentColor: "#eab308" },
  { id: "energy", name: "Energie", icon: Zap, color: "yellow", gradient: "from-yellow-400 to-amber-500", accentColor: "#facc15" },
  { id: "government", name: "Overheid", icon: Landmark, color: "blue", gradient: "from-blue-700 to-indigo-700", accentColor: "#1d4ed8" },
  { id: "nonprofit", name: "Non-profit", icon: Heart, color: "pink", gradient: "from-pink-400 to-rose-500", accentColor: "#f472b6" },
  { id: "security", name: "Beveiliging", icon: Shield, color: "slate", gradient: "from-slate-600 to-zinc-700", accentColor: "#475569" },
  { id: "support", name: "Klantenservice", icon: Headphones, color: "teal", gradient: "from-teal-500 to-cyan-600", accentColor: "#14b8a6" },
  { id: "retail", name: "Retail", icon: Package, color: "lime", gradient: "from-lime-500 to-green-600", accentColor: "#84cc16" },
  { id: "agriculture", name: "Landbouw", icon: Leaf, color: "green", gradient: "from-green-600 to-emerald-700", accentColor: "#16a34a" },
  { id: "telecom", name: "Telecom", icon: Globe, color: "blue", gradient: "from-blue-500 to-cyan-600", accentColor: "#3b82f6" },
  { id: "insurance", name: "Verzekeringen", icon: ShieldCheck, color: "indigo", gradient: "from-indigo-600 to-blue-700", accentColor: "#4f46e5" },
];
...
export const TOOLS: Tool[] = [
  // ========== FINANCE ==========
  {
    ...
    description: "Zet PDF facturen om naar Excel/CSV. Herkent automatisch KvK, BTW-nummers en alle regels.",
  ...
  },
  {
    ...
    description: "Genereer winnende offertes op basis van je input. Direct PDF export.",
  ...
  {
    id: "expense-tracker",
    title: "Bonnetjes Scanner",
    description: "Scan bonnetjes en declaraties. Automatische categorisatie voor je boekhouding.",
  ...
  },
  {
    ...
    title: "Cashflow Voorspeller",
    description: "AI-gedreven cashflow voorspellingen op basis van je historische data.",
  ...
  },
  {
    ...
    description: "Stel budgetten op en krijg automatisch alerts bij overschrijdingen.",
  ...
  // ========== LEGAL ==========
  {
    ...
    description: "Upload een contract en krijg direct een analyse van risico's en valkuilen.",
  ...
  },
  {
    ...
    description: "Genereer juridisch dichte voorwaarden op maat voor jouw bedrijf.",
    href: "/tools/terms-generator",
    icon: ShieldCheck,
    status: "live",
    sector: "legal",
  },
  {
    ...
    description: "AVG-conforme privacyverklaring op maat. Inclusief cookie policy.",
  ...
  },
  {
    id: "nda-generator",
    title: "NDA Generator",
    description: "Genereer professionele geheimhoudingsverklaringen in enkele klikken.",
  ...
  {
    id: "legal-letter",
    title: "Juridische Brief Schrijver",
    description: "Van aanmaningen tot bezwaarschriften. AI schrijft, jij verstuurt.",
    href: "/tools/legal-letter",
    icon: Gavel,
    status: "soon",
    sector: "legal",
  },
  ...
  // ========== HR ==========
  {
    id: "cv-screener",
    title: "CV Screener",
    description: "Upload 20 CV's en krijg automatisch de top 3 kandidaten voor je vacature.",
    href: "/tools/cv-screener",
    icon: Users,
    status: "soon",
    sector: "hr",
  },
  {
    id: "job-writer",
    title: "Vacature Schrijver",
    description: "Schrijf inclusieve en wervende vacatureteksten die talent aantrekken.",
    href: "/tools/job-writer",
    icon: Briefcase,
    status: "soon",
    sector: "hr",
  },
  {
    ...
    description: "Genereer complete onboarding checklists voor nieuwe medewerkers.",
  ...
  },
  {
    ...
    description: "AI genereert relevante interviewvragen op basis van de functie.",
  ...
  },
  {
    ...
    title: "Beoordelings Assistent",
    description: "Structureer functioneringsgesprekken met AI-gegenereerde templates.",
  ...
  // ========== MARKETING ==========
  {
    ...
    description: "Verander een saaie blogpost of nieuwsartikel in een virale LinkedIn post.",
    href: "/tools/social-writer",
    icon: Linkedin,
    status: "soon",
    sector: "marketing",
  },
  {
    id: "email-writer",
    title: "Cold Outreach",
    description: "Genereer gepersonaliseerde sales emails voor potentiële klanten.",
  ...
  },
  {
    ...
    description: "Schrijf converterende Facebook, Google en Instagram advertenties.",
    href: "/tools/ad-copy",
    icon: Megaphone,
    status: "soon",
    sector: "marketing",
  },
  {
    id: "seo-optimizer",
    title: "SEO Optimizer",
    description: "Analyseer en optimaliseer je content voor betere Google rankings.",
  ...
  {
    id: "content-calendar",
    title: "Content Kalender AI",
    description: "Genereer een maand aan social media content ideeën in minuten.",
  ...
  {
    id: "proposal-writer",
    title: "Voorstel Schrijver",
    description: "Van briefing naar winnend voorstel. AI doet het zware werk.",
  ...
  },
  {
    id: "lead-scorer",
    title: "Lead Scorer",
    description: "Prioriteer je leads automatisch op basis van conversiepotentieel.",
    href: "/tools/lead-scorer",
    icon: Target,
    status: "soon",
    sector: "sales",
  },
  {
    id: "meeting-prep",
    title: "Meeting Voorbereider",
    description: "AI research je prospect en geeft je talking points voor het gesprek.",
    href: "/tools/meeting-prep",
    icon: Briefcase,
    status: "soon",
    sector: "sales",
  },
  ...
  // ========== E-COMMERCE ==========
  {
    ...
    title: "Product Beschrijvingen",
    description: "Genereer SEO-geoptimaliseerde productbeschrijvingen in bulk.",
  ...
  {
    id: "review-responder",
    title: "Review Beantwoorder",
    description: "Reageer professioneel op klantreviews. Positief én negatief.",
  ...
  // ========== TECHNOLOGY ==========
  {
    id: "code-reviewer",
    title: "Code Reviewer",
    description: "AI analyseert je code op bugs, security issues en best practices.",
  ...
  {
    id: "api-docs",
    title: "API Documentatie Generator",
    description: "Genereer professionele API docs op basis van je endpoints.",
    href: "/tools/api-docs",
    icon: Database,
    status: "soon",
    sector: "technology",
  ...
  // ========== SUPPORT ==========
  {
    ...
    description: "Genereer gepersonaliseerde antwoorden op klantvragen.",
    href: "/tools/ticket-responder",
    icon: Headphones,
    status: "soon",
    sector: "support",
  },
  {
    id: "faq-generator",
    title: "FAQ Generator",
    description: "Analyseer je support tickets en genereer een FAQ sectie.",
  ...
  // ========== CREATIVE ==========
  {
    ...
    description: "Genereer unieke afbeeldingen voor je website en social media.",
  ...
  {
    id: "logo-ideas",
    title: "Logo Ideeën Generator",
    description: "Krijg AI-gegenereerde logo concepten voor je merk.",
    href: "/tools/logo-ideas",
    icon: Palette,
    status: "soon",
    sector: "creative",
  },
  ...
  {
    id: "swot-analyzer",
    title: "SWOT Analyse Tool",
    description: "Genereer een SWOT analyse op basis van je bedrijfsinformatie.",
    href: "/tools/swot-analyzer",
    icon: BarChart3,
    status: "soon",
    sector: "consulting",
  },
  {
    ...
    description: "Van idee naar onderbouwd business plan. Inclusief financiële projecties.",
